...
class Empleado(models.Model):
    ...
    email = models.CharField(verbose_name='Correo del empleado', max_length=50)
    empresa = models.ForeignKey(Empresa, verbose_name='Empresa', on_delete=models.CASCADE, related_name='empleados')
